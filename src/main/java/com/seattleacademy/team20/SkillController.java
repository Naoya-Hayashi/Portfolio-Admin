...
//
//		public void initialize() throws IOException {
//		FileInputStream refreshToken = new FileInputStream("/Users/nao8/Downloads/develop-protfolio2020121-firebase-adminsdk-qcr8z-2b0605b198.json");
//			FirebaseOptions options = new FirebaseOptions.Builder()
//					.setCredentials(GoogleCredentials.fromStream(refreshToken))
//					.setDatabaseUrl("https://develop-protfolio2020121.firebaseio.com/")
//					.build();
//			app = FirebaseApp.initializeApp(options,"other");
//	}
//
...
//		final String sql ="select * from skills";
//		//fromはmySQLのテーブル名かと
//		return jdbcTemplate.quary(sql, new RowMapper<Skill>() {
//
//			public Skills mapRow(ResultSet rs, int rowNum) throws SQLException{
//				return new  Skills(rs.getInt("id"), rs.getString("category"),
...
//				.setDatabaseUrl("https://test-mysql-pull.firebaseio.com/")
//				.build();
...
////
////	final FirebaseDatabase database = FirebaseDatabase.getInstance(app);
////	DatabaseReference reference = database.getReference("skills");
////
////	List<Map<String, Object>> dataList = new ArrayList<Map<String , Object>>();
...
////	}
////	reference.setValue(dataList, new DatabaseReference.CompletionListener() {
////
////		@Override
////		public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
